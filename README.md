...
To run the permutation test, I split the dataframe into recipes that takes less or equal to 15 minutes and recipes that takes more than 15 minutes, and meaure their precision. The observed absolute difference of their precision is about 0.0005. I do the same thing after shuffling the `minutes` column. I performed 100 times for the permutation test due to the limit performance of my laptop. The p-value I got is 0.41. Therefore, I fail to reject the null hypothesis. The model is fair for recipes with short time and recipes that takes longer time. 